  ...
  return (
    <main className="min-h-screen bg-[#F7F8FA] flex justify-center items-start px-4">
      <div className="mt-11 mb-[60px] shrink-0 w-full max-w-[690px] md:w-[72.917%] md:max-w-[1400px] md:rounded-md md:bg-white md:shadow-[0_0_10px_0_rgba(0,0,0,0.12)]">
        <h1 className="font-medium text-[#1D1E1F] leading-normal text-left text-[40px] md:text-[20px] md:mt-[30px] md:ml-[30px]">
          {title}
        </h1>
        {subtitle && (
          <div className="mt-[18px] font-normal leading-normal text-[#999] text-[24px] md:text-[12px] md:ml-[30px]">
            {subtitle}
          </div>
        )}
        ...
        <div className="py-5 flex justify-center md:px-16 md:py-12">
          <div
            className="prose-news mb-8 prose-news-mobile"
            style={{ fontSize: "32px" }}
