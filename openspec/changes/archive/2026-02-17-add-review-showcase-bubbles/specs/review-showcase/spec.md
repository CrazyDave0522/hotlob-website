...
- Include unit tests verifying: top-3 selection, truncation behavior, graceful degrade when fetch fails.
- Include an integration snapshot for desktop and mobile renderings.
